    ...
    public class FileSystemDriver : IDriver
    {
        ...
        JsonResult IDriver.Upload(string target, System.Web.HttpFileCollectionBase targets)
        {
            ...
            for (int i = 0; i < targets.AllKeys.Length; i++)
            {
                ...
                //string tempFolderPath = Server.MapPath("~/" + "Areas/Admin/images/");
                //string fileName = "kvsrnaidu";
                ...
                obj.CompressImage(sourceimage, path.FullName);
                ...
                //{
                //    //ImageCompression obj = new ImageCompression();
                //    //obj.CompressImage(sourceimage, path.FullName, file.FileName);
